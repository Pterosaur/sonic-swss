...
impl<W: OutputWriter> StatsReporterActor<W> {
    ...
    fn stat_id_to_string(&self, _type_id: u32, stat_id: u32) -> String {
        // For now, just return the stat_id as string until we implement proper conversion
        // In the future, this could be enhanced with specific stat enum conversions
